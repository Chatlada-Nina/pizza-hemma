...
class OrderAdmin(admin.ModelAdmin):
    ...
    fields = ('order_number', 'user_profile', 'date','full_name', 'email', 'phone_number','delivery_method', 'address', 'postcode', 'delivery_cost', 'order_total', 'grand_total', 'original_cart', 'stripe_pid',)
